...
while True: #since it seems that Al Sweigart recommends this for starting all of his programs
    print('Did you do a workout of some sort or other yesterday? (Please use "yes" or "no")')
    prior_wkt = input()
    if prior_wkt == 'yes':
        print('Go for a walk for at least half an hour.')
        print('Workout is done for the day, go home, eat your vegetables, drink water, get 8 hours of sleep.')
    elif prior_wkt == 'no':
        print("This workout recommendation is for an absolute beginner, it's pretty hard to get hurt on this one but standard disclaimers apply of getting doctor approval and  you assume all liability for damages.  This is a coding project, not a fitness recommendation.")
        print("""
